...
//fazendo conexão com o banco de dados
 ...
 //criar sql d econsulta
  $sql = "select * from tb_inscritos where cod_ins = '$id'";                                             
 //realizar consulta
  ...
  <div class="content-wrapper">
    <div class="col col-lg-9 m-auto">
      <div class="alert alert-info text-dark alert-dismissible fade show" role="alert">
        Preencha todos os campos para realizar a alteração.
      ...
      <div class="row mt-3">
        <div class="col-lg-12">
          <div class="card col col-9 m-auto">
            <div class="card-body">
              <form name="f1" method="POST" action="alterarins.php">
           <div class="form-group">
            <input value="<?php echo $linha['cod_ins']; ?>" type="hidden" class="form-control" id="cod_ins" name="cod_ins">
           </div>
           <div class="form-group">
            <label for="input-1">Nome Completo</label>
            <input value="<?php echo $linha['nome']; ?>" type="text" class="form-control" id="nome" name="nome" placeholder="Digite seu nome completo" autocomplete="off">
           </div>
           <div class="form-group">
            <label for="input-2">CPF</label>
            <input value="<?php echo $linha['cpf']; ?>" type="text" class="form-control" id="cpf" name="cpf" placeholder="Digite seu CPF">
           </div>
           <div class="form-group">
            <label for="input-3">Email</label>
            <input value="<?php echo $linha['email']; ?>" type="text" class="form-control" id="email" name="email" placeholder="Digite seu email" autocomplete="off">
           </div>
           <div class="form-group">
            <label for="input-4">Contato</label>
            <input value="<?php echo $linha['contato']; ?>" type="text" class="form-control" id="contato" name="contato" placeholder="Digite seu contato">
           </div>
           <hr>
           <div class="form-group">
            <label for="input-5">CEP</label>
            <input value="<?php echo $linha['cep']; ?>" type="text" class="form-control" id="cep" name="cep" placeholder="Digite seu CEP">
           </div>
           <div class="form-group">
            <label for="input-6">Estado</label>
            <select class="form-control" id="estado" name="estado">
              <option value="" data-default disabled selected><?php echo $linha['estado']; ?></option>
           ...
           <div class="form-group">
            ...
            <input value="<?php echo $linha['cidade']; ?>" type="text" class="form-control" id="cidade" name="cidade" placeholder="Digite sua cidade" autocomplete="off">
           </div>
           <div class="form-group">
            <label for="input-8">Bairro</label>
            <input value="<?php echo $linha['bairro']; ?>" type="text" class="form-control" id="bairro" name="bairro" placeholder="Digite seu bairro" autocomplete="off">
           </div>
           <div class="form-group">
            <label for="input-9">Endereço</label>
            <input value="<?php echo $linha['endereco']; ?>" type="text" class="form-control" id="endereco" name="endereco" placeholder="Digite seu endereço" autocomplete="off">
           </div>
           <div class="form-group">
            <label for="input-10">Número</label>
            <input value="<?php echo $linha['numero']; ?>" type="text" class="form-control" id="numero" name="numero" placeholder="Digite o número da sua casa" autocomplete="off">
           </div>
           <div class="form-group">
            <label for="input-11">Complemento</label>
            <input value="<?php echo $linha['complemento']; ?>" type="text" class="form-control" id="complemento" name="complemento" placeholder="Digite um complemento" autocomplete="off">
           </div>
           <hr>
           <div class="form-group">
              <label for="input-12">Evento</label>
              <select class="form-control" id="evento" name="evento">
              <option value="" data-default disabled selected><?php echo $linha['evento']; ?></option>
           ...
           <div class="form-group">
            ...
            <input value="<?php echo $linha['pos_evento']; ?>" type="text" class="form-control" id="pos_evento" name="pos_evento" autocomplete="off">
           </div>
